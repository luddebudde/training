...
const applyForceTo = (body, direction) =>
...
const playerABody = createPlayer(
  green,
  playerStartDist + roomDim.wallThickness / 2,
)
const playerBBody = createPlayer(
  red,
  roomDim.width - playerStartDist - roomDim.wallThickness / 2,
)

const ballRadius = 20
const rubberBall = Bodies.circle(
  roomDim.width / 2,
  roomDim.height / 2,
  ballRadius,
  {
